/* eslint-disable */
// Generated by Wrangler by running `wrangler types` (hash: 93d85af55779f4b77d8c9a8199d63594)
// Runtime types generated with workerd@1.20260401.1 2026-04-05 nodejs_compat
declare namespace Cloudflare {
	interface GlobalProps {
		mainModule: typeof import("./worker/index");
		durableNamespaces: "PlanSession" | "McpSession";
	}
	interface Env {
		IMAGES: ImagesBinding;
		ASSETS: Fetcher;
		PLAN_SESSION: DurableObjectNamespace<import("./worker/index").PlanSession>;
		MCP_SESSION: DurableObjectNamespace<import("./worker/index").McpSession>;
	}
}
